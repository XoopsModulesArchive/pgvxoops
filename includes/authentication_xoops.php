 ...
 */
if (mb_strstr($_SERVER['SCRIPT_NAME'], 'authentication')) {
...
{
    global $TBLPREFIX, $memberHandler;
    ...
    $xusers = $memberHandler->getUsers(null, false);
...
{
    global $TBLPREFIX, $users, $REGEXP_DB, $xoopsUser, $memberHandler;
    ...
    $xuser = $memberHandler->getUsers(new Criteria('uname', $username), false);
...
function AddToLog($LogString, $savelangerror = false)
{
    ...
    if ('none' !== $LOGFILE_CREATE && false === $savelangerror) {
