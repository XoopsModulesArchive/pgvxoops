 ...
 */
if (mb_strstr($_SERVER['PHP_SELF'], 'functions_date_hijri.php')) {
...
function getHijri($d, $m, $y)
{
    ...
    $format = str_replace('y', mb_substr($y, 2), $format);
