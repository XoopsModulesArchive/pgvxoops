...
MYSQLI_TYPE_GEOMETRY => 'geometry',
     ...
     *
     * @return void TRUE on success, FALSE if $result is invalid
     *
     * @see DB_result::free()
     */
    ...
    public function numRows($result)
    {
        ...
        return $rows ?? $this->mysqliRaiseError();
    }
    ...
    public function nextId($seq_name, $ondemand = true)
    {
        ...
        do {
            ...
            if (DB_OK === $result) {
                ...
                $result = $this->query(
                    'REPLACE INTO ' . $seqname . ' (id) VALUES (0)'
                );
                ...
                return 1;
                      ...
                      && DB_ERROR_NOSUCHTABLE == $result->getCode()) {
                ...
                return 1;
                      ...
                      && DB_ERROR_ALREADY_EXISTS == $result->getCode()) {
                // BACKWARDS COMPAT
    ...
    {
        return @$GLOBALS['xoopsDB']->escape($this->connection, $str);
    }
    ...
    public function tableInfo($result, $mode = null)
    {
        ...
        for ($i = 0; $i < $count; $i++) {
            ...
            $res[$i] = [
                ...
                'type' => $this->mysqli_types[$tmp->type] ?? 'unknown',
                'len' => $tmp->max_length,
                'flags' => $flags,
            ];
