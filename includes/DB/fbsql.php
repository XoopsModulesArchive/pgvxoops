...
361 => DB_ERROR_CONSTRAINT,
     ...
     *
     * @return void DB_OK on success.  A DB_Error object if the driver
     ...
     *
     * @return void DB_OK on success.  A DB_Error object on failure.
     */
    ...
    public function numRows($result)
    {
        ...
        return $rows ?? $this->fbsqlRaiseError();
    }
    ...
    {
        return $this->query(
            'DROP TABLE ' . $this->getSequenceName($seq_name) . ' RESTRICT'
        );
    }
