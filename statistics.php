...
function get_person()
{
    ...
    for ($i = 0; $i < $nrpers; $i++) {
        ...
        if (false !== dateplace($indirec, '1 BIRT')) {
            $birthdate = $match1[1];
        ...
        if (false !== dateplace($indirec, '1 DEAT')) {
            $deathdate = $match1[1];
        ...
        if (false !== stringinfo($indirec, '1 SEX')) {
            $sex = 0;
...
function get_family()
{
    ...
    for ($i = 0; $i < $nrfam; $i++) {
        ...
        if (false !== dateplace($indirec, '1 MARR')) {
            $marriagedate = $match1[1];

            $marriageplace = $match2[1];

            $sex = 1;
        } elseif (false !== dateplace($indirec, '1 MARS')) {
            $marriagedate = $match1[1];
        ...
        if (false !== dateplace($indirec, '1 DIV')) {
