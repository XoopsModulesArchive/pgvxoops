        ...
        if (displayDetails($indirec) || showLivingName($indirec)) {
            ...
            if ($famids || ($num > 1)) {
                ...
                if ('rtl' == $TEXT_DIRECTION) {
                    print 'rtl" style="position:absolute; ';
                } else {
                    print 'ltr" style="position:absolute; ';
                }
                ...
                if ('rtl' == $TEXT_DIRECTION) {
                    print 'rtl" style="position:absolute; right: 20px; ';
                } else {
                    print 'ltr" style="position:absolute; left: 20px;';
                }
...
function print_person_pedigree($pid, $count)
{
    ...
    foreach ($famids as $indexval => $famid) {
        ...
        if ($count < $generations - 1) {
            print '<td rowspan="2"><img src="' . $PGV_IMAGE_DIR . '/' . $PGV_IMAGES['hline']['other'] . "\" width=\"7\" height=\"3\"></td>\n";
        }
        ...
        if ($count < $generations - 1) {
            print '<tr><td height="50%"><img src="' . $PGV_IMAGE_DIR . '/' . $PGV_IMAGES['spacer']['other'] . "\" width=\"3\"></td></tr>\n";
        }
...
if ('preview' != $view) {
    ...
    print '<br><br><br></td><td class="subheaders" style="width: 60px; vertical-align:bottom;text-align: ' . ('rtl' == $TEXT_DIRECTION ? 'left' : 'right') . ';">';
