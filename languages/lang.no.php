...
$pgv_lang['gedcom_downloadable'] = '<br>Besøkende på nettstedet ditt kan laste ned (download) denne GEDCOM-filen!<br>Les mer om dette i filen <a href="'
                                   . (file_exists('readme-norsk.txt') ? 'readme-norsk.txt' : 'readme.txt')
                                   . '">readme'
                                   . (file_exists('readme-norsk.txt') ? '-norsk' : '')
                                   . '.txt</a> i avsnittet 12. SIKKERHET / PERSONVERN<br>for å finne en løsning på dette.';
...
if (file_exists($PGV_BASE_DIRECTORY . 'languages/lang.no.extra.php')) {
    require $PGV_BASE_DIRECTORY . 'languages/lang.no.extra.php';
}
