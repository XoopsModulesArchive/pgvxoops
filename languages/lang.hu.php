...
$pgv_lang['stpljpgraphno'] = 'JPgraph modules not available in phpgedview/jpgraph/ . Please get them from http://www.aditus.nu/jpgraph/jpdownload.php<br> <h3>First install JPgraph in directory PhpGedview/jpgraph/</h3><br>';
...
if (file_exists($PGV_BASE_DIRECTORY . 'languages/lang.hu.extra.php')) {
    require $PGV_BASE_DIRECTORY . 'languages/lang.hu.extra.php';
}
