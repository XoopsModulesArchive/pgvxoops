...
if ('download' == $action) {
    ...
    if (isset($otherlist['HEAD'])) {
        ...
        if (false !== $pos1) {
            ...
            $newhead = mb_substr($head, 0, $pos1);

            $newhead .= mb_substr($head, $pos2 + 1);
        ...
        if (false === mb_strstr($head, '1 PLAC')) {
    ...
    <form name="convertform" method="post">
        ...
        <table>
            <tr>
                <td align="right"><input type="checkbox" name="convert" value="yes"></td>
                <td align="left"><?php print $pgv_lang['utf8_to_ansi'];

    print_help_link('utf8_ansi_help', 'qm'); ?></td>
            </tr>
            <tr>
                <td align="right"><input type="checkbox" name="remove" value="yes" checked></td>
                <td align="left"><?php print $pgv_lang['remove_custom_tags'];
