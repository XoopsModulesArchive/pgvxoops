...
switch ($action) {
    case 'pwlost':
        ...
        <form name="requestpwform" action="login_register.php" method="post" onsubmit="t = new Date(); document.requestpwform.time.value=t.toUTCString(); return checkform(this);">
            ...
            <table>
                ...
                <tr>
                    <td <?php write_align_with_textdir_check('right'); ?>><?php print $pgv_lang['emailadress'] ?></td>
    ...
    case 'requestpw':
        ...
        if (!isset($newuser) || ($newuser['username'] != $user_name)) {
            ...
            $user_new_pw = md5(uniqid(mt_rand()));
            ...
            if ('/' == mb_substr($SERVER_URL, -1)) {
                $mail_body .= mb_substr($SERVER_URL, 0, (mb_strlen($SERVER_URL) - 1));
            } else {
        ...
        <center>
            <form name="registerform" method="post" action="login_register.php" onsubmit="t = new Date(); document.registerform.time.value=t.toUTCString(); return checkform(this);">
                ...
                <table width="80%" border="0">
                    <tr>
                        <td colspan="2">
                            <center><span class="subheaders"><?php print_text('requestaccount'); ?></span></center>
                            <br><br> <?php print_text('register_info_01'); ?></td>
                    </tr>
                    <tr>
                        <td class="facts_label" valign="top" align="left"><?php print $pgv_lang['username'];
                            print_help_link('username_help', 'qm'); ?></td>
                        <td class="facts_value" valign="top" <?php write_align_with_textdir_check('left'); ?>><input type="text" name="user_name" value=""> <span class="warning">*</span><br><font class="warning" size="2"><?php print $pgv_lang['pls_note01']; ?></font></td>
                    </tr>
                    <tr>
                        <td class="facts_label" valign="top" align="left"><?php print $pgv_lang['password'];
                            print_help_link('edituser_password_help', 'qm'); ?></td>
                        <td class="facts_value" valign="top" <?php write_align_with_textdir_check('left'); ?>><input type="password" name="user_password01" value=""> <span class="warning">*</span><br><font class="warning" size="2">(<?php print $pgv_lang['min6chars']; ?>)</font></td>
                    </tr>
                    <tr>
                        <td class="facts_label" valign="top" align="left"><?php print $pgv_lang['confirm'];
                            print_help_link('edituser_conf_password_help', 'qm'); ?></td>
                        <td class="facts_value" valign="top" <?php write_align_with_textdir_check('left'); ?>><input type="password" name="user_password02" value=""> <span class="warning">*</span><br><font size="2"><?php print $pgv_lang['pls_note02']; ?></font></td>
                    </tr>
                    <tr>
                        <td class="facts_label" valign="top" align="left"><?php print $pgv_lang['fullname'];
                            print_help_link('new_user_fullname_help', 'qm'); ?></td>
                        <td class="facts_value" valign="top" <?php write_align_with_textdir_check('left'); ?>><input type="text" name="user_fullname" value=""> <span class="warning">*</span></td>
                    </tr>
                    <?php
                    if ($ENABLE_MULTI_LANGUAGE) {
                        ...
                        print_help_link('edituser_change_lang_help', 'qm');
                    ...
                    ?>
                    <tr>
                        <td class="facts_label" valign="top" align="left"><?php print $pgv_lang['emailadress'];
                            print_help_link('edituser_email_help', 'qm'); ?></td>
                        <td class="facts_value" valign="top" <?php write_align_with_textdir_check('left'); ?>><input type="text" size="30" name="user_email" value=""> <span class="warning">*</span><br><font class="warning" size="2"><?php print $pgv_lang['pls_note03']; ?></font></td>
                    </tr>
                    <?php if (!$REQUIRE_AUTHENTICATION && $SHOW_LIVING_NAMES >= $PRIV_PUBLIC) { ?>
                        <tr>
                            <td class="facts_label" valign="top" align="left"><?php print $pgv_lang['gedcomid'];
                                print_help_link('register_gedcomid_help', 'qm'); ?></td>
                            <td class="facts_value" valign="top" <?php write_align_with_textdir_check('left'); ?>><input type="text" size="10" name="user_gedcomid" value=""> <font size="1"> <a href="javascript:open_find(document.registerform.user_gedcomid);"><?php print $pgv_lang['find_id']; ?></a></font>
                            </td>
                        </tr>
                    <?php } ?>
                    <tr>
                        <td class="facts_label" valign="top" align="left"><?php print $pgv_lang['comments'];
                            print_help_link('register_comments_help', 'qm'); ?></td>
                        <td class="facts_value" valign="top" <?php write_align_with_textdir_check('left'); ?>><textarea cols="50" rows="5" name="user_comments" value=""></textarea><span class="warning">*</span><br><?php print $pgv_lang['pls_note12']; ?></td>
                    </tr>
                    <tr>
                        <td align="left" colspan="2" <?php write_align_with_textdir_check('left'); ?>><font class="warning" size="2"><?php print $pgv_lang['pls_note04']; ?></font></td>
                    </tr>
                    <tr>
                        <td align="center" colspan="2"><br><input type="submit" value="<?php print $pgv_lang['requestaccount']; ?>"><br><br></td>
                    </tr>
                    <tr>
                        <td colspan="2"><?php print_text('pls_note05'); ?></td>
                    </tr>
                </table>
            </form>
        </center>
    ...
    case 'registernew':
        ...
        if (false !== stripos($user_name, "SUNTZU") || false !== stripos($user_email, "SUNTZU")) {
        ...
        $i = 1;
        $pass = true;
        while (mb_strlen($user_name) > $i) {
            if (true !== mb_stristr($alphabet, $user_name[$i])) {
                $pass = false;
        ...
        if (true === $pass) {
            ...
            if (false !== getUser($user_name)) {
                ...
                $user['reg_hashcode'] = crypt(mt_rand(), $user_password01);
            ...
            if ($user_created_ok) {
                ...
                if ('/' == mb_substr($SERVER_URL, -1)) {
                    $mail_body .= mb_substr($SERVER_URL, 0, (mb_strlen($SERVER_URL) - 1)) . '/login_register.php?action=userverify&user_name=' . urlencode($user_name) . '&user_hashcode=' . urlencode($user['reg_hashcode']) . "\r\n";
                } else {
    ...
    case 'userverify':
        ...
        <table width="80%" class="<?php print $TEXT_DIRECTION; ?>">
            <tr>
                <td align="center" colspan="2"><span class="subheaders"><?php print $pgv_lang['user_verify']; ?><br><br></span></td>
            </tr>
            <tr>
                <td colspan="2"><?php print $pgv_lang['pls_note07']; ?><br><br></td>
            </tr>
            <tr>
                <td class="facts_label" valign="top" align="left"><?php print $pgv_lang['username']; ?></td>
                <td class="facts_value" valign="top"><input type="text" name="user_name" value="<?php print $user_name; ?>"><br><font class="warning" size="2"><?php print $pgv_lang['pls_note01']; ?></font></td>
            </tr>
            <tr>
                <td class="facts_label" valign="top" align="left"><?php print $pgv_lang['password']; ?></td>
                <td class="facts_value" valign="top"><input type="password" name="user_password" value=""></td>
            </tr>
            <tr>
                <td class="facts_label" valign="top" align="left"><?php print $pgv_lang['hashcode']; ?></td>
                <td class="facts_value" valign="top"><input type="text" name="user_hashcode" value="<?php print $user_hashcode; ?>"></td>
            </tr>
            <tr>
                <td align="left">&nbsp;</td>
                <td><br><input type="submit" value="<?php print $pgv_lang['send']; ?>"><br><br></td>
            </tr>
        </table>
        </form><?php
        print '</center>';
