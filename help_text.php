...
$actione = $action ?? '';
if (('help_useradmin.php' == $help) && ('edituser' == $actione)) {
    $help = 'edit_useradmin_help';
}
if (('help_login_register.php' == $help) && ('pwlost' == $actione)) {
    $help = 'help_login_lost_pw.php';
}
if ('help_contents_help' == $help) {
    if (userIsAdmin(getUserName())) {
        $help = 'admin_help_contents_help';

        print $pgv_lang['admin_help_contents_head_help'];
    } else {
        print $pgv_lang['help_contents_head_help'];
    }
