...
// Remove slashes
if (isset($_POST['NEW_COMMON_NAMES_ADD'])) {
    $_POST['NEW_COMMON_NAMES_ADD'] = stripslashes($_POST['NEW_COMMON_NAMES_ADD']);
}
if (isset($_POST['NEW_COMMON_NAMES_REMOVE'])) {
    $_POST['NEW_COMMON_NAMES_REMOVE'] = stripslashes($_POST['NEW_COMMON_NAMES_REMOVE']);
}
...
if ('update' == $action) {
    ...
    if ($slpos) {
        $FILE = mb_substr($GEDCOMPATH, $slpos + 1);
    } else {
        $FILE = $GEDCOMPATH;
    }
    ...
    if (0 == preg_match("'://'", $_POST['NEW_HOME_SITE_URL'])) {
        $_POST['NEW_HOME_SITE_URL'] = 'http://' . $_POST['NEW_HOME_SITE_URL'];
    }
    ...
    */
    ...
    if (!$errors) {
        ...
        if (!check_for_import($FILE)) {
            header("Location: validategedcom.php?ged=$FILE");
        } else {
            header('Location: editgedcoms.php');
        }
...
$THEME_DIR = $temp2;
if (!check_for_import($FILE)) {
    print '<span class="subheaders">' . $pgv_lang['step2'] . ' ' . $pgv_lang['configure'] . ' + ' . $pgv_lang['ged_gedcom'] . '</span><br><br>';
}
if (!isset($NTHEME_DIR)) {
...
?>
    ...
    <form method="post" name="configform" action="editconfig_gedcom.php">
        ...
        <?php
        if (!empty($error_msg)) {
            print '<br><span class="error">' . $error_msg . "</span><br>\n";
        }
        $i = 0;
        ?>
        ...
        <table class="facts_table">
            <tr>
                <td class="facts_label03" style="text-align:<?php if ('ltr' == $TEXT_DIRECTION) {
            print 'left';
        } else {
            print 'right';
        } ?>; ">
        ...
        <div id="file-options" style="display: block">
            <table class="facts_table">
                ...
                <td class="facts_value"><input type="text" name="GEDCOMPATH" value="<?php print preg_replace('/\\*/', '\\', $GEDCOMPATH); ?>" size="40" dir="ltr" tabindex="<?php $i++;
                    print $i ?>" onfocus="getHelp('gedcom_path_help');">
                    <?php
                    if (!file_exists($GEDCOMPATH)) {
                        if ('.ged' != mb_strtolower(mb_substr(trim($GEDCOMPATH), -4))) {
                            $GEDCOMPATH .= '.ged';
                        }
                    }
                    if ((!mb_strstr($GEDCOMPATH, '://')) && (!file_exists($GEDCOMPATH))) {
                        $gedcomsplit = preg_preg_split("/\//", $GEDCOMPATH);

                        foreach ($gedcomsplit as $indexval => $gedcomname) {
                            if (mb_stristr($gedcomname, 'ged')) {
                ...
                <tr>
                    ...
                    <td class="facts_value"><input type="text" name="gedcom_title" value="<?php print preg_replace('/"/', '&quot;', PrintReady($gedcom_title)); ?>" size="40" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('gedcom_title_help');"></td>
                </tr>
                <tr>
                    ...
                    <td class="facts_value"><input type="hidden" name="changelanguage" value="yes">
                        <select name="GEDCOMLANG" onfocus="getHelp('LANGUAGE_help');" tabindex="<?php $i++;
                        print $i ?>">
                            <?php
                ...
                <tr>
                    ...
                    <td class="facts_value"><input type="text" name="NEW_CHARACTER_SET" value="<?php print $CHARACTER_SET ?>" onfocus="getHelp('CHARACTER_SET_help');" tabindex="<?php $i++;
                        print $i ?>"></td>
                </tr>
                <tr>
                        ...
                        if ($fpged) {
                            ...
                            while (!feof($fpged)) {
                                ...
                                if ($ct > 0) {
                                    ...
                                    $pos1 = mb_strpos($fcontents, "0 @$gid@", 0);
                                    ...
                                    if (false === $pos1) {
                                        ...
                                        if ($pos2) {
                                            $indirec = mb_substr($fcontents, $pos1, $pos2 - $pos1);
                                        } else {
                                            $indirec = mb_substr($fcontents, $pos1);
                                        }
                    ...
                    ?>
                    <td class="facts_value"><input type="text" name="NEW_PEDIGREE_ROOT_ID" value="<?php print $PEDIGREE_ROOT_ID ?>" size="5" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('PEDIGREE_ROOT_ID_help');">
                        <?php
                        if (!empty($indirec)) {
                        ...
                        if (check_for_import($GEDCOM)) {
                            print '<a href="#" onclick="open_find(document.configform.NEW_PEDIGREE_ROOT_ID); return false;"> ' . $pgv_lang['find_id'] . '</a>';
                        }
                        ?>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="facts_value"><select name="NEW_CALENDAR_FORMAT" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('CALENDAR_FORMAT_help');" onchange="show_jewish(this, 'hebrew-cal');">
                            <option value="gregorian" <?php if ('gregorian' == $CALENDAR_FORMAT) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['gregorian']; ?></option>
                            <option value="julian" <?php if ('julian' == $CALENDAR_FORMAT) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['julian']; ?></option>
                            <option value="french" <?php if ('french' == $CALENDAR_FORMAT) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['config_french']; ?></option>
                            <option value="jewish" <?php if ('jewish' == $CALENDAR_FORMAT) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['jewish']; ?></option>
                            <option value="jewish_and_gregorian" <?php if ('jewish_and_gregorian' == $CALENDAR_FORMAT) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['jewish_and_gregorian']; ?></option>
                            <option value="hebrew" <?php if ('hebrew' == $CALENDAR_FORMAT) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['config_hebrew']; ?></option>
                            <option value="hebrew_and_gregorian" <?php if ('hebrew_and_gregorian' == $CALENDAR_FORMAT) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['hebrew_and_gregorian']; ?></option>
                            <option value="arabic" <?php if ('arabic' == $CALENDAR_FORMAT) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['arabic_cal']; ?></option>
                            <option value="hijri" <?php if ('hijri' == $CALENDAR_FORMAT) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['hijri']; ?></option>
                        </select>
                    </td>
                </tr>
            </table>
            <div id="hebrew-cal" style="display: <?php if (('jewish' == $CALENDAR_FORMAT) || ('jewish_and_gregorian' == $CALENDAR_FORMAT) || ('hebrew' == $CALENDAR_FORMAT) || ('hebrew_and_gregorian' == $CALENDAR_FORMAT)) {
                            print 'block';
                        } else {
                            print 'none';
                        } ?>;">
                <table class="facts_table">
                    <tr>
                        ...
                        <td class="facts_value"><select name="NEW_DISPLAY_JEWISH_THOUSANDS" onfocus="getHelp('DISPLAY_JEWISH_THOUSANDS_help');">
                                <option value="yes" <?php if ($DISPLAY_JEWISH_THOUSANDS) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['yes']; ?></option>
                                <option value="no" <?php if (!$DISPLAY_JEWISH_THOUSANDS) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['no']; ?></option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="facts_value"><select name="NEW_DISPLAY_JEWISH_GERESHAYIM" onfocus="getHelp('DISPLAY_JEWISH_GERESHAYIM_help');">
                                <option value="yes" <?php if ($DISPLAY_JEWISH_GERESHAYIM) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['yes']; ?></option>
                                <option value="no" <?php if (!$DISPLAY_JEWISH_GERESHAYIM) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['no']; ?></option>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="facts_value"><select name="NEW_JEWISH_ASHKENAZ_PRONUNCIATION" onfocus="getHelp('JEWISH_ASHKENAZ_PRONUNCIATION_help');">
                                <option value="yes" <?php if ($JEWISH_ASHKENAZ_PRONUNCIATION) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['yes']; ?></option>
                                <option value="no" <?php if (!$JEWISH_ASHKENAZ_PRONUNCIATION) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['no']; ?></option>
                            </select>
                        </td>
            ...
            <table class="facts_table">
                <tr>
                    ...
                    <td class="facts_value"><select name="NEW_USE_RTL_FUNCTIONS" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('USE_RTL_FUNCTIONS_help');">
                            <option value="yes" <?php if ($USE_RTL_FUNCTIONS) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['yes']; ?></option>
                            <option value="no" <?php if (!$USE_RTL_FUNCTIONS) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['no']; ?></option>
                        </select>
                    </td>
                ...
                <tr>
                    ...
                    <td class="facts_value"><select name="NEW_USE_RIN" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('USE_RIN_help');">
                            <option value="yes" <?php if ($USE_RIN) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['yes']; ?></option>
                            <option value="no" <?php if (!$USE_RIN) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['no']; ?></option>
                        </select>
                    </td>
                ...
                <tr>
                    ...
                    <td class="facts_value"><input type="text" name="NEW_GEDCOM_ID_PREFIX" value="<?php print $GEDCOM_ID_PREFIX ?>" size="5" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('GEDCOM_ID_PREFIX_help');">
                    </td>
                </tr>
                <tr>
                    <td class="facts_label"><?php print $pgv_lang['SOURCE_ID_PREFIX']; ?> <a href="#" onclick="return helpPopup('SOURCE_ID_PREFIX_help');"><b>?</b></a></td>
                    <td class="facts_value"><input type="text" name="NEW_SOURCE_ID_PREFIX" value="<?php print $SOURCE_ID_PREFIX ?>" size="5" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('SOURCE_ID_PREFIX_help');">
                    </td>
                </tr>
                <tr>
                    <td class="facts_label"><?php print $pgv_lang['REPO_ID_PREFIX']; ?> <a href="#" onclick="return helpPopup('REPO_ID_PREFIX_help');"><b>?</b></a></td>
                    <td class="facts_value"><input type="text" name="NEW_REPO_ID_PREFIX" value="<?php print $REPO_ID_PREFIX ?>" size="5" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('REPO_ID_PREFIX_help');">
                    </td>
                </tr>
                <tr>
                    <td class="facts_label"><?php print $pgv_lang['SEARCHLOG_CREATE']; ?> <a href="#" onclick="return helpPopup('SEARCHLOG_CREATE_help');"><b>?</b></a></td>
                    <td class="facts_value"><select name="NEW_SEARCHLOG_CREATE" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('SEARCHLOG_CREATE_help');">
                            <option value="none" <?php if ('none' == $SEARCHLOG_CREATE) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['no_logs']; ?></option>
                            <option value="daily" <?php if ('daily' == $SEARCHLOG_CREATE) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['daily']; ?></option>
                            <option value="weekly" <?php if ('weekly' == $SEARCHLOG_CREATE) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['weekly']; ?></option>
                            <option value="monthly" <?php if ('monthly' == $SEARCHLOG_CREATE) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['monthly']; ?></option>
                            <option value="yearly" <?php if ('yearly' == $SEARCHLOG_CREATE) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['yearly']; ?></option>
                        </select>
                    </td>
                </tr>
                <tr>
                    <td class="facts_label"><?php print $pgv_lang['TIME_LIMIT']; ?> <a href="#" onclick="return helpPopup('TIME_LIMIT_help');"><b>?</b></a></td>
                    <td class="facts_value"><input type="text" name="NEW_TIME_LIMIT" value="<?php print $TIME_LIMIT ?>" size="5" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('TIME_LIMIT_help');"></td>
                </tr>
            </table>
        </div>
        ...
        <div id="config-media" style="display: none">
            <table class="facts_table">
                <tr>
                    ...
                    <td class="facts_value"><select name="NEW_MULTI_MEDIA" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('MULTI_MEDIA_help');">
                            <option value="yes" <?php if ($MULTI_MEDIA) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['yes']; ?></option>
                            <option value="no" <?php if (!$MULTI_MEDIA) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['no']; ?></option>
                        </select>
                    </td>
                ...
                <tr>
                    ...
                    <td class="facts_value"><select name="NEW_MULTI_MEDIA_DB" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('MULTI_MEDIA_DB_help');">
                            <option value="yes" <?php if ($MULTI_MEDIA_DB) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['yes']; ?></option>
                            <option value="no" <?php if (!$MULTI_MEDIA_DB) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['no']; ?></option>
                        </select>
                    </td>
                ...
                <tr>
                    ...
                    <td class="facts_value"><select name="NEW_MEDIA_EXTERNAL" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('MEDIA_EXTERNAL_help');">
                            <option value="yes" <?php if ($MEDIA_EXTERNAL) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['yes']; ?></option>
                            <option value="no" <?php if (!$MEDIA_EXTERNAL) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['no']; ?></option>
                        </select>
                    </td>
                ...
                <tr>
                    ...
                    <td class="facts_value"><input type="text" size="50" name="NEW_MEDIA_DIRECTORY" value="<?php print $MEDIA_DIRECTORY ?>" dir="ltr" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('MEDIA_DIRECTORY_help');">
                        <?php
                        if (preg_match('/.*[a-zA-Z]{1}:.*/', $MEDIA_DIRECTORY) > 0) {
                            print '<span class="error">' . $pgv_lang['media_drive_letter'] . "</span>\n";
                        }
                        ?>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="facts_value"><input type="text" name="NEW_MEDIA_DIRECTORY_LEVELS" value="<?php print $MEDIA_DIRECTORY_LEVELS ?>" size="5" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('MEDIA_DIRECTORY_LEVELS_help');"></td>
                </tr>
                <tr>
                    ...
                    <td class="facts_value"><select name="NEW_SHOW_HIGHLIGHT_IMAGES" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('SHOW_HIGHLIGHT_IMAGES_help');">
                            <option value="yes" <?php if ($SHOW_HIGHLIGHT_IMAGES) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['yes']; ?></option>
                            <option value="no" <?php if (!$SHOW_HIGHLIGHT_IMAGES) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['no']; ?></option>
                        </select>
                    </td>
                ...
                <tr>
                    ...
                    <td class="facts_value"><select name="NEW_USE_THUMBS_MAIN" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('USE_THUMBS_MAIN_help');">
                            <option value="yes" <?php if ($USE_THUMBS_MAIN) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['yes']; ?></option>
                            <option value="no" <?php if (!$USE_THUMBS_MAIN) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['no']; ?></option>
                        </select>
                    </td>
        ...
        <div id="access-options" style="display: none">
            <table class="facts_table">
                <tr>
                    ...
                    <td class="facts_value"><select name="NEW_HIDE_LIVE_PEOPLE" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('HIDE_LIVE_PEOPLE_help');">
                            <option value="yes" <?php if ($HIDE_LIVE_PEOPLE) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['yes']; ?></option>
                            <option value="no" <?php if (!$HIDE_LIVE_PEOPLE) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['no']; ?></option>
                        </select>
                    </td>
                ...
                <tr>
                    ...
                    <td class="facts_value"><select name="NEW_REQUIRE_AUTHENTICATION" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('REQUIRE_AUTHENTICATION_help');">
                            <option value="yes" <?php if ($REQUIRE_AUTHENTICATION) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['yes']; ?></option>
                            <option value="no" <?php if (!$REQUIRE_AUTHENTICATION) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['no']; ?></option>
                        </select>
                    </td>
                ...
                <tr>
                    ...
                    <td class="facts_value"><select name="NEW_WELCOME_TEXT_AUTH_MODE" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('WELCOME_TEXT_AUTH_MODE_help');">
                            <option value="1" <?php if ('1' == $WELCOME_TEXT_AUTH_MODE) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['WELCOME_TEXT_AUTH_MODE_OPT1']; ?></option>
                            <option value="2" <?php if ('2' == $WELCOME_TEXT_AUTH_MODE) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['WELCOME_TEXT_AUTH_MODE_OPT2']; ?></option>
                            <option value="3" <?php if ('3' == $WELCOME_TEXT_AUTH_MODE) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['WELCOME_TEXT_AUTH_MODE_OPT3']; ?></option>
                            <option value="4" <?php if ('4' == $WELCOME_TEXT_AUTH_MODE) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['WELCOME_TEXT_AUTH_MODE_OPT4']; ?></option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="facts_value"><select name="NEW_WELCOME_TEXT_CUST_HEAD" onfocus="getHelp('WELCOME_TEXT_AUTH_MODE_CUST_HEAD_help');" tabindex="<?php $i++;
                        print $i ?>">
                            <option value="yes" <?php if ($WELCOME_TEXT_CUST_HEAD) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['yes']; ?></option>
                            <option value="no" <?php if (!$WELCOME_TEXT_CUST_HEAD) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['no']; ?></option>
                        </select>
                    </td>
                ...
                <tr>
                    ...
                    <td class="facts_value"><textarea name="NEW_WELCOME_TEXT_AUTH_MODE_4" rows="5" cols="60" dir="ltr" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('WELCOME_TEXT_AUTH_MODE_CUST_help');"><?php print $WELCOME_TEXT_AUTH_MODE_4 ?></textarea>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="facts_value"><select name="NEW_CHECK_CHILD_DATES" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('CHECK_CHILD_DATES_help');">
                            <option value="yes" <?php if ($CHECK_CHILD_DATES) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['yes']; ?></option>
                            <option value="no" <?php if (!$CHECK_CHILD_DATES) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['no']; ?></option>
                        </select>
                    </td>
        ...
        <div id="layout-options" style="display: none">
            ...
            <table class="facts_table">
                <tr>
                    <td class="facts_value" style="text-align:<?php if ('ltr' == $TEXT_DIRECTION) {
                        print 'left';
                    } else {
                        print 'right';
                    } ?>; ">
            ...
            <div id="layout-options2" style="display: none">
                <table class="facts_table">
                    <tr>
                        ...
                        <td class="facts_value"><select name="NEW_PEDIGREE_FULL_DETAILS" tabindex="<?php $i++;
                            print $i ?>" onfocus="getHelp('PEDIGREE_FULL_DETAILS_help');">
                                <option value="yes" <?php if ($PEDIGREE_FULL_DETAILS) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['yes']; ?></option>
                                <option value="no" <?php if (!$PEDIGREE_FULL_DETAILS) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['no']; ?></option>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="facts_value"><select name="NEW_ABBREVIATE_CHART_LABELS" tabindex="<?php $i++;
                            print $i ?>" onfocus="getHelp('ABBREVIATE_CHART_LABELS_help');">
                                <option value="yes" <?php if ($ABBREVIATE_CHART_LABELS) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['yes']; ?></option>
                                <option value="no" <?php if (!$ABBREVIATE_CHART_LABELS) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['no']; ?></option>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="facts_value"><select name="NEW_SHOW_PARENTS_AGE" tabindex="<?php $i++;
                            print $i ?>" onfocus="getHelp('SHOW_PARENTS_AGE_help');">
                                <option value="yes" <?php if ($SHOW_PARENTS_AGE) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['yes']; ?></option>
                                <option value="no" <?php if (!$SHOW_PARENTS_AGE) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['no']; ?></option>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="facts_value"><select name="NEW_SHOW_LDS_AT_GLANCE" tabindex="<?php $i++;
                            print $i ?>" onfocus="getHelp('SHOW_LDS_AT_GLANCE_help');">
                                <option value="yes" <?php if ($SHOW_LDS_AT_GLANCE) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['yes']; ?></option>
                                <option value="no" <?php if (!$SHOW_LDS_AT_GLANCE) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['no']; ?></option>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="facts_value">
                            <input type="text" size="50" name="NEW_CHART_BOX_TAGS" value="<?php print $CHART_BOX_TAGS ?>" dir="ltr" tabindex="<?php $i++;
                            print $i ?>" onfocus="getHelp('CHART_BOX_TAGS_help');">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="facts_value"><select name="NEW_SHOW_MARRIED_NAMES" tabindex="<?php $i++;
                            print $i ?>" onfocus="getHelp('SHOW_MARRIED_NAMES_help');">
                                <option value="yes" <?php if ($SHOW_MARRIED_NAMES) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['yes']; ?></option>
                                <option value="no" <?php if (!$SHOW_MARRIED_NAMES) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['no']; ?></option>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="facts_value"><select name="NEW_UNDERLINE_NAME_QUOTES" tabindex="<?php $i++;
                            print $i ?>" onfocus="getHelp('UNDERLINE_NAME_QUOTES_help');">
                                <option value="yes" <?php if ($UNDERLINE_NAME_QUOTES) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['yes']; ?></option>
                                <option value="no" <?php if (!$UNDERLINE_NAME_QUOTES) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['no']; ?></option>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="facts_value"><select name="NEW_SHOW_ID_NUMBERS" tabindex="<?php $i++;
                            print $i ?>" onfocus="getHelp('SHOW_ID_NUMBERS_help');">
                                <option value="yes" <?php if ($SHOW_ID_NUMBERS) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['yes']; ?></option>
                                <option value="no" <?php if (!$SHOW_ID_NUMBERS) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['no']; ?></option>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="facts_value"><select name="NEW_SHOW_FAM_ID_NUMBERS" tabindex="<?php $i++;
                            print $i ?>" onfocus="getHelp('SHOW_FAM_ID_NUMBERS_help');">
                                <option value="yes" <?php if ($SHOW_FAM_ID_NUMBERS) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['yes']; ?></option>
                                <option value="no" <?php if (!$SHOW_FAM_ID_NUMBERS) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['no']; ?></option>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="facts_value"><select name="NEW_NAME_FROM_GEDCOM" tabindex="<?php $i++;
                            print $i ?>" onfocus="getHelp('NAME_FROM_GEDCOM_help');">
                                <option value="yes" <?php if ($NAME_FROM_GEDCOM) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['yes']; ?></option>
                                <option value="no" <?php if (!$NAME_FROM_GEDCOM) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['no']; ?></option>
                            </select>
                        </td>
            ...
            <div id="layout-options3" style="display: none">
                <table class="facts_table">
                    <tr>
                        ...
                        <td class="facts_value"><input type="text" name="NEW_COMMON_NAMES_THRESHOLD" value="<?php print $COMMON_NAMES_THRESHOLD ?>" size="5" tabindex="<?php $i++;
                            print $i ?>" onfocus="getHelp('COMMON_NAMES_THRESHOLD_help');"></td>
                    </tr>

                    <tr>
                        <td class="facts_label"><?php print $pgv_lang['COMMON_NAMES_ADD']; ?> <a href="#" onclick="return helpPopup('COMMON_NAMES_ADD_help');"><b>?</b></a></td>
                        <td class="facts_value"><input type="text" name="NEW_COMMON_NAMES_ADD" value="<?php print $COMMON_NAMES_ADD ?>" size="50" tabindex="<?php $i++;
                            print $i ?>" onfocus="getHelp('COMMON_NAMES_ADD_help');"></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="facts_value"><input type="text" name="NEW_COMMON_NAMES_REMOVE" value="<?php print $COMMON_NAMES_REMOVE ?>" size="50" tabindex="<?php $i++;
                            print $i ?>" onfocus="getHelp('COMMON_NAMES_REMOVE_help');"></td>
                    </tr>
                </table>
            </div>
            ...
            <div id="layout-options4" style="display: none">
                <table class="facts_table">
                    <tr>
                        ...
                        <td class="facts_value"><input type="text" name="NEW_DEFAULT_PEDIGREE_GENERATIONS" value="<?php print $DEFAULT_PEDIGREE_GENERATIONS ?>" size="5" tabindex="<?php $i++;
                            print $i ?>" onfocus="getHelp('DEFAULT_PEDIGREE_GENERATIONS_help');"></td>
                    </tr>
                    <tr>
                        ...
                        <td class="facts_value"><input type="text" name="NEW_MAX_PEDIGREE_GENERATIONS" value="<?php print $MAX_PEDIGREE_GENERATIONS ?>" size="5" tabindex="<?php $i++;
                            print $i ?>" onfocus="getHelp('MAX_PEDIGREE_GENERATIONS_help');"></td>
                    </tr>
                    <tr>
                        ...
                        <td class="facts_value"><input type="text" name="NEW_MAX_DESCENDANCY_GENERATIONS" value="<?php print $MAX_DESCENDANCY_GENERATIONS ?>" size="5" tabindex="<?php $i++;
                            print $i ?>" onfocus="getHelp('DMAX_DESCENDANCY_GENERATIONS_help');"></td>
                    </tr>
                    <tr>
                        <td class="facts_label"><?php print $pgv_lang['PEDIGREE_LAYOUT']; ?> <a href="#" onclick="return helpPopup('PEDIGREE_LAYOUT_help');"><b>?</b></a></td>
                        <td class="facts_value"><select name="NEW_PEDIGREE_LAYOUT" tabindex="<?php $i++;
                            print $i ?>" onfocus="getHelp('PEDIGREE_LAYOUT_help');">
                                <option value="yes" <?php if ($PEDIGREE_LAYOUT) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['landscape']; ?></option>
                                <option value="no" <?php if (!$PEDIGREE_LAYOUT) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['portrait']; ?></option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="facts_value"><input type="text" size="5" name="NEW_SHOW_PEDIGREE_PLACES" value="<?php print $SHOW_PEDIGREE_PLACES; ?>" tabindex="<?php $i++;
                            print $i ?>" onfocus="getHelp('SHOW_PEDIGREE_PLACES_help');"></td>
                    </tr>
                    <tr>
                        <td class="facts_label"><?php print $pgv_lang['ZOOM_BOXES']; ?> <a href="#" onclick="return helpPopup('ZOOM_BOXES_help');"><b>?</b></a></td>
                        <td class="facts_value"><select name="NEW_ZOOM_BOXES" tabindex="<?php $i++;
                            print $i ?>" onfocus="getHelp('ZOOM_BOXES_help');">
                                <option value="disabled" <?php if ('disabled' == $ZOOM_BOXES) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['disabled']; ?></option>
                                <option value="mouseover" <?php if ('mouseover' == $ZOOM_BOXES) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['mouseover']; ?></option>
                                <option value="mousedown" <?php if ('mousedown' == $ZOOM_BOXES) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['mousedown']; ?></option>
                                <option value="click" <?php if ('click' == $ZOOM_BOXES) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['click']; ?></option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        <td class="facts_label"><?php print $pgv_lang['LINK_ICONS']; ?> <a href="#" onclick="return helpPopup('LINK_ICONS_help');"><b>?</b></a></td>
                        <td class="facts_value"><select name="NEW_LINK_ICONS" tabindex="<?php $i++;
                            print $i ?>" onfocus="getHelp('LINK_ICONS_help');">
                                <option value="disabled" <?php if ('disabled' == $LINK_ICONS) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['disabled']; ?></option>
                                <option value="mouseover" <?php if ('mouseover' == $LINK_ICONS) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['mouseover']; ?></option>
                                <option value="click" <?php if ('click' == $LINK_ICONS) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['click']; ?></option>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="facts_value"><select name="NEW_GEDCOM_DEFAULT_TAB" tabindex="<?php $i++;
                            print $i ?>" onfocus="getHelp('GEDCOM_DEFAULT_TAB_help');">
                                <option value="0" <?php if (0 == $GEDCOM_DEFAULT_TAB) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['personal_facts']; ?></option>
                                <option value="1" <?php if (1 == $GEDCOM_DEFAULT_TAB) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['notes']; ?></option>
                                <option value="2" <?php if (2 == $GEDCOM_DEFAULT_TAB) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['ssourcess']; ?></option>
                                <option value="3" <?php if (3 == $GEDCOM_DEFAULT_TAB) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['media']; ?></option>
                                <option value="4" <?php if (4 == $GEDCOM_DEFAULT_TAB) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['relatives']; ?></option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="facts_value"><select name="NEW_ALPHA_INDEX_LISTS" tabindex="<?php $i++;
                            print $i ?>" onfocus="getHelp('ALPHA_INDEX_LISTS_help');">
                                <option value="yes" <?php if ($ALPHA_INDEX_LISTS) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['yes']; ?></option>
                                <option value="no" <?php if (!$ALPHA_INDEX_LISTS) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['no']; ?></option>
                            </select>
                        </td>
            ...
            <div id="layout-options5" style="display: none">
                <table class="facts_table">
                    <tr>
                        ...
                        <td class="facts_value"><select name="NEW_SHOW_EMPTY_BOXES" tabindex="<?php $i++;
                            print $i ?>" onfocus="getHelp('SHOW_EMPTY_BOXES_help');">
                                <option value="yes" <?php if ($SHOW_EMPTY_BOXES) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['yes']; ?></option>
                                <option value="no" <?php if (!$SHOW_EMPTY_BOXES) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['no']; ?></option>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="facts_value"><select name="NEW_SHOW_GEDCOM_RECORD" tabindex="<?php $i++;
                            print $i ?>" onfocus="getHelp('SHOW_GEDCOM_RECORD_help');">
                                <option value="yes" <?php if ($SHOW_GEDCOM_RECORD) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['yes']; ?></option>
                                <option value="no" <?php if (!$SHOW_GEDCOM_RECORD) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['no']; ?></option>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="facts_value"><select name="NEW_HIDE_GEDCOM_ERRORS" tabindex="<?php $i++;
                            print $i ?>" onfocus="getHelp('HIDE_GEDCOM_ERRORS_help');">
                                <option value="yes" <?php if ($HIDE_GEDCOM_ERRORS) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['yes']; ?></option>
                                <option value="no" <?php if (!$HIDE_GEDCOM_ERRORS) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['no']; ?></option>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="facts_value"><select name="NEW_WORD_WRAPPED_NOTES" tabindex="<?php $i++;
                            print $i ?>" onfocus="getHelp('WORD_WRAPPED_NOTES_help');">
                                <option value="yes" <?php if ($WORD_WRAPPED_NOTES) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['yes']; ?></option>
                                <option value="no" <?php if (!$WORD_WRAPPED_NOTES) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['no']; ?></option>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="facts_value"><input type="text" name="NEW_FAVICON" value="<?php print $FAVICON ?>" size="40" dir="ltr" tabindex="<?php $i++;
                            print $i ?>" onfocus="getHelp('FAVICON_help');"></td>
                    </tr>
                    <tr>
                        <td class="facts_label"><?php print $pgv_lang['SHOW_COUNTER']; ?> <a href="#" onclick="return helpPopup('SHOW_COUNTER_help');"><b>?</b></a></td>
                        <td class="facts_value"><select name="NEW_SHOW_COUNTER" tabindex="<?php $i++;
                            print $i ?>" onfocus="getHelp('SHOW_COUNTER_help');">
                                <option value="yes" <?php if ($SHOW_COUNTER) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['yes']; ?></option>
                                <option value="no" <?php if (!$SHOW_COUNTER) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['no']; ?></option>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="facts_value"><select name="NEW_SHOW_STATS" tabindex="<?php $i++;
                            print $i ?>" onfocus="getHelp('SHOW_STATS_help');">
                                <option value="yes" <?php if ($SHOW_STATS) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['yes']; ?></option>
                                <option value="no" <?php if (!$SHOW_STATS) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['no']; ?></option>
                            </select>
                        </td>
        ...
        <div id="user-options" style="display: none">
            <table class="facts_table">
                <tr>
                    ...
                    <td class="facts_value"><select name="NEW_ALLOW_EDIT_GEDCOM" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('ALLOW_EDIT_GEDCOM_help');">
                            <option value="yes" <?php if ($ALLOW_EDIT_GEDCOM) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['yes']; ?></option>
                            <option value="no" <?php if (!$ALLOW_EDIT_GEDCOM) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['no']; ?></option>
                        </select>
                    </td>
                ...
                <tr>
                    ...
                    <td class="facts_value"><select name="NEW_SPLIT_PLACES" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('SPLIT_PLACES_help');">
                            <option value="yes" <?php if ($SPLIT_PLACES) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['yes']; ?></option>
                            <option value="no" <?php if (!$SPLIT_PLACES) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['no']; ?></option>
                        </select>
                    </td>
                ...
                <tr>
                    ...
                    <td class="facts_value"><select name="NEW_USE_QUICK_UPDATE" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('USE_QUICK_UPDATE_help');">
                            <option value="yes" <?php if ($USE_QUICK_UPDATE) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['yes']; ?></option>
                            <option value="no" <?php if (!$USE_QUICK_UPDATE) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['no']; ?></option>
                        </select>
                    </td>
                ...
                <tr>
                    ...
                    <td class="facts_value"><select name="NEW_SHOW_QUICK_RESN" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('SHOW_QUICK_RESN_help');">
                            <option value="yes" <?php if ($SHOW_QUICK_RESN) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['yes']; ?></option>
                            <option value="no" <?php if (!$SHOW_QUICK_RESN) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['no']; ?></option>
                        </select>
                    </td>
                ...
                <tr>
                    ...
                    <td class="facts_value"><select name="NEW_ENABLE_MULTI_LANGUAGE" onfocus="getHelp('ENABLE_MULTI_LANGUAGE_help');" tabindex="<?php $i++;
                        print $i ?>">
                            <option value="yes" <?php if ($ENABLE_MULTI_LANGUAGE) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['yes']; ?></option>
                            <option value="no" <?php if (!$ENABLE_MULTI_LANGUAGE) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['no']; ?></option>
                        </select>
                    </td>
                ...
                <tr>
                    ...
                    <td class="facts_value"><select name="NEW_SHOW_CONTEXT_HELP" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('SHOW_CONTEXT_HELP_help');">
                            <option value="yes" <?php if ($SHOW_CONTEXT_HELP) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['yes']; ?></option>
                            <option value="no" <?php if (!$SHOW_CONTEXT_HELP) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['no']; ?></option>
                        </select>
                    </td>
                ...
                <tr>
                    ...
                    <td class="facts_value">
                        <select name="themeselect" tabindex="<?php $i++;
                        print $i ?>" onchange="document.configform.NTHEME_DIR.value=document.configform.themeselect.options[document.configform.themeselect.selectedIndex].value;">
                            <?php
                            $themes = get_theme_names();
                            foreach ($themes as $indexval => $themedir) {
                                print '<option value="' . $themedir['dir'] . '"';

                                if ($themedir['dir'] == $NTHEME_DIR) {
                                    print ' selected="selected"';
                                }
                            ...
                            ?>
                            <option value="themes/" <?php if ('themes//' == $themeselect) {
                                print 'selected="selected"';
                            } ?>><?php print $pgv_lang['other_theme']; ?></option>
                        </select>
                        <input type="text" name="NTHEME_DIR" value="<?php print $NTHEME_DIR ?>" size="40" dir="ltr" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('THEME_DIR_help');">
                        <?php
                        if (!file_exists($NTHEME_DIR)) {
                ...
                <tr>
                    ...
                    <td class="facts_value"><select name="NEW_ALLOW_THEME_DROPDOWN" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('ALLOW_THEME_DROPDOWN_help');">
                            <option value="yes" <?php if ($ALLOW_THEME_DROPDOWN) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['yes']; ?></option>
                            <option value="no" <?php if (!$ALLOW_THEME_DROPDOWN) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['no']; ?></option>
                        </select>
                    </td>
        ...
        <div id="contact-options" style="display: none">
            <table class="facts_table">
                <tr>
                    ...
                    <td class="facts_value"><select name="NEW_CONTACT_EMAIL" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('CONTACT_EMAIL_help');">
                            <?php
                            if ('you@yourdomain.com' == $CONTACT_EMAIL) {
                                $CONTACT_EMAIL = getUserName();
                            }
                            $users = getUsers();
                            foreach ($users as $indexval => $user) {
                                if ('yes' == $user['verified_by_admin']) {
                                    print '<option value="' . $user['username'] . '"';

                                    if ($CONTACT_EMAIL == $user['username']) {
                                        print ' selected="selected"';
                                    }
                ...
                <tr>
                    ...
                    <td class="facts_value"><select name="NEW_CONTACT_METHOD" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('CONTACT_METHOD_help');">
                            <?php if ($PGV_STORE_MESSAGES) { ?>
                                <option value="messaging" <?php if ('messaging' == $CONTACT_METHOD) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['messaging']; ?></option>
                                <option value="messaging2" <?php if ('messaging2' == $CONTACT_METHOD) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['messaging2']; ?></option>
                            <?php } else { ?>
                                <option value="messaging3" <?php if ('messaging3' == $CONTACT_METHOD) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['messaging3']; ?></option>
                            <?php } ?>
                            <option value="mailto" <?php if ('mailto' == $CONTACT_METHOD) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['mailto']; ?></option>
                            <option value="none" <?php if ('none' == $CONTACT_METHOD) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['no_messaging']; ?></option>
                        </select>
                    </td>
                </tr>
                <tr>
                    <td class="facts_label"><?php print $pgv_lang['WEBMASTER_EMAIL']; ?> <a href="#" onclick="return helpPopup('WEBMASTER_EMAIL_help');"><b>?</b></a></td>
                    <td class="facts_value"><select name="NEW_WEBMASTER_EMAIL" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('WEBMASTER_EMAIL_help');">
                            <?php
                            $users = getUsers();
                            if ('webmaster@yourdomain.com' == $WEBMASTER_EMAIL) {
                                $WEBMASTER_EMAIL = getUserName();
                            }
                            ...
                            foreach ($users as $indexval => $user) {
                                if (userIsAdmin($user['username'])) {
                                    ...
                                    if ($WEBMASTER_EMAIL == $user['username']) {
                                        print ' selected="selected"';
                                    }
                ...
                <tr>
                    ...
                    <td class="facts_value"><select name="NEW_SUPPORT_METHOD" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('SUPPORT_METHOD_help');">
                            <?php if ($PGV_STORE_MESSAGES) { ?>
                                <option value="messaging" <?php if ('messaging' == $SUPPORT_METHOD) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['messaging']; ?></option>
                                <option value="messaging2" <?php if ('messaging2' == $SUPPORT_METHOD) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['messaging2']; ?></option>
                            <?php } else { ?>
                                <option value="messaging3" <?php if ('messaging3' == $SUPPORT_METHOD) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['messaging3']; ?></option>
                            <?php } ?>
                            <option value="mailto" <?php if ('mailto' == $SUPPORT_METHOD) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['mailto']; ?></option>
                            <option value="none" <?php if ('none' == $SUPPORT_METHOD) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['no_messaging']; ?></option>
                        </select>
                    </td>
        ...
        <div id="config-meta" style="display: none">
            <table class="facts_table">
                <tr>
                    ...
                    <td class="facts_value"><input type="text" name="NEW_HOME_SITE_URL" value="<?php print $HOME_SITE_URL ?>" size="50" dir="ltr" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('HOME_SITE_URL_help');"></td>
                </tr>
                <tr>
                    <td class="facts_label"><?php print $pgv_lang['HOME_SITE_TEXT']; ?> <a href="#" onclick="return helpPopup('HOME_SITE_TEXT_help');"><b>?</b></a></td>
                    <td class="facts_value"><input type="text" name="NEW_HOME_SITE_TEXT" value="<?php print htmlspecialchars($HOME_SITE_TEXT, ENT_QUOTES | ENT_HTML5); ?>" size="50" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('HOME_SITE_TEXT_help');"></td>
                </tr>
                <tr>
                    <td class="facts_label"><?php print $pgv_lang['META_AUTHOR']; ?> <a href="#" onclick="return helpPopup('META_AUTHOR_help');"><b>?</b></a></td>
                    <td class="facts_value"><input type="text" name="NEW_META_AUTHOR" value="<?php print $META_AUTHOR ?>" onfocus="getHelp('META_AUTHOR_help');" tabindex="<?php $i++;
                        print $i ?>"><br>
                ...
                <tr>
                    ...
                    <td class="facts_value"><input type="text" name="NEW_META_PUBLISHER" value="<?php print $META_PUBLISHER ?>" onfocus="getHelp('META_PUBLISHER_help');" tabindex="<?php $i++;
                        print $i ?>"><br>
                ...
                <tr>
                    ...
                    <td class="facts_value"><input type="text" name="NEW_META_COPYRIGHT" value="<?php print $META_COPYRIGHT ?>" onfocus="getHelp('META_COPYRIGHT_help');" tabindex="<?php $i++;
                        print $i ?>"><br>
                ...
                <tr>
                    ...
                    <td class="facts_value"><input type="text" name="NEW_META_DESCRIPTION" value="<?php print $META_DESCRIPTION ?>" onfocus="getHelp('META_DESCRIPTION_help');" tabindex="<?php $i++;
                        print $i ?>"><br>
                ...
                <tr>
                    ...
                    <td class="facts_value"><input type="text" name="NEW_META_PAGE_TOPIC" value="<?php print $META_PAGE_TOPIC ?>" onfocus="getHelp('META_PAGE_TOPIC_help');" tabindex="<?php $i++;
                        print $i ?>"><br>
                ...
                <tr>
                    ...
                    <td class="facts_value"><input type="text" name="NEW_META_AUDIENCE" value="<?php print $META_AUDIENCE ?>" onfocus="getHelp('META_AUDIENCE_help');" tabindex="<?php $i++;
                        print $i ?>"><br>
                    </td>
                </tr>
                <tr>
                    <td class="facts_label"><?php print $pgv_lang['META_PAGE_TYPE']; ?> <a href="#" onclick="return helpPopup('META_PAGE_TYPE_help');"><b>?</b></a></td>
                    <td class="facts_value"><input type="text" name="NEW_META_PAGE_TYPE" value="<?php print $META_PAGE_TYPE ?>" onfocus="getHelp('META_PAGE_TYPE_help');" tabindex="<?php $i++;
                        print $i ?>"><br>
                    </td>
                </tr>
                <tr>
                    <td class="facts_label"><?php print $pgv_lang['META_ROBOTS']; ?> <a href="#" onclick="return helpPopup('META_ROBOTS_help');"><b>?</b></a></td>
                    <td class="facts_value"><input type="text" name="NEW_META_ROBOTS" value="<?php print $META_ROBOTS ?>" onfocus="getHelp('META_ROBOTS_help');" tabindex="<?php $i++;
                        print $i ?>"><br>
                    </td>
                </tr>
                <tr>
                    <td class="facts_label"><?php print $pgv_lang['META_REVISIT']; ?> <a href="#" onclick="return helpPopup('META_REVISIT_help');"><b>?</b></a></td>
                    <td class="facts_value"><input type="text" name="NEW_META_REVISIT" value="<?php print $META_REVISIT ?>" onfocus="getHelp('META_REVISIT_help');" tabindex="<?php $i++;
                        print $i ?>"><br>
                    </td>
                </tr>
                <tr>
                    <td class="facts_label"><?php print $pgv_lang['META_KEYWORDS']; ?> <a href="#" onclick="return helpPopup('META_KEYWORDS_help');"><b>?</b></a></td>
                    <td class="facts_value"><input type="text" name="NEW_META_KEYWORDS" value="<?php print $META_KEYWORDS ?>" onfocus="getHelp('META_KEYWORDS_help');" tabindex="<?php $i++;
                        print $i ?>" size="75"><br>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="facts_value"><select name="NEW_META_SURNAME_KEYWORDS" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('META_SURNAME_KEYWORDS_help');">
                            <option value="yes" <?php if ($META_SURNAME_KEYWORDS) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['yes']; ?></option>
                            <option value="no" <?php if (!$META_SURNAME_KEYWORDS) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['no']; ?></option>
                        </select>
                    </td>
                ...
                <tr>
                    ...
                    <td class="facts_value"><input type="text" name="NEW_META_TITLE" value="<?php print $META_TITLE ?>" onfocus="getHelp('META_TITLE_help');" tabindex="<?php $i++;
                        print $i ?>" size="75"></td>
                </tr>
            </table>
        </div>
        <table class="facts_table" border="0">
            ...
            <tr>
                <td>
                    ...
                    print $i ?>" value="<?php print $pgv_lang['save_config'] ?>" onclick="closeHelp();">
                    &nbsp;&nbsp;
                    <input type="reset" tabindex="<?php $i++;
                    print $i ?>" value="<?php print $pgv_lang['reset'] ?>"><br>
                </td>
            </tr>
        </table>
    </form>
    <br><?php if (!check_for_import($FILE)) {
                        print_text('return_editconfig_gedcom');
                    } ?><br>
<?php if (0 == count($GEDCOMS)) { ?>
    <script language="JavaScript" type="text/javascript">
