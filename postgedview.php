...
if (isset($_COOKIE['def_canedit'])) {
    $def_canedit = $_COOKIE['def_canedit'];
}
if (isset($_COOKIE['def_canadmin'])) {
    $def_canadmin = $_COOKIE['def_canadmin'];
}
if (isset($_COOKIE['def_theme'])) {
    $def_theme = $_COOKIE['def_theme'];
}
if (isset($_COOKIE['def_rootid'])) {
    $def_rootid = $_COOKIE['def_rootid'];
}
if (isset($_COOKIE['def_verified'])) {
    $def_verified = $_COOKIE['def_verified'];
}
if (isset($_COOKIE['def_verified_by_admin'])) {
    $def_verified_by_admin = $_COOKIE['def_verified_by_admin'];
}
if (isset($_COOKIE['def_contact_method'])) {
    $def_contact_method = $_COOKIE['def_contact_method'];
}
if (isset($_COOKIE['def_gedcom'])) {
    $def_gedcom = $_COOKIE['def_gedcom'];
}
if (isset($_COOKIE['def_language'])) {
    $def_language = $_COOKIE['def_language'];
}
if (isset($_COOKIE['def_upass'])) {
    $def_upass = $_COOKIE['def_upass'];
}
if (isset($_COOKIE['def_create_user'])) {
    $def_create_user = $_COOKIE['def_create_user'];
}

if (isset($_COOKIE['post_user'])) {
    $post_user = $_COOKIE['post_user'];
}
if (isset($_COOKIE['post_fullname'])) {
    $post_fullname = $_COOKIE['post_fullname'];
}
if (isset($_COOKIE['post_email'])) {
    $post_email = $_COOKIE['post_email'];
}
if (isset($_COOKIE['post_canedit'])) {
    $post_canedit = $_COOKIE['post_canedit'];
}

if (!empty($post_user)) {
    // need to add the user into gedview - but only if def_create_user says its ok

    if (!getUser($post_user) and ('yes' == $def_create_user)) {
        $newuser = [];
    ...
    if (getUser($post_user) and ('yes' == $admin_ver)) {
