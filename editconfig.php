...
if ($CONFIGURED) {
    if (('index' == $PGV_DATABASE) || (check_db())) {
        ...
        if (!adminUserExists()) {
            ...
            if ('createadminuser' == $action) {
                ...
                <form method="post" onsubmit="return checkform(this);">
                    ...
                    <table>
                        <tr>
                            <td align="right"><?php print $pgv_lang['username']; ?></td>
                            <td><input type="text" name="username"></td>
                        </tr>
                        <tr>
                            <td align="right"><?php print $pgv_lang['fullname']; ?></td>
                            <td><input type="text" name="fullname"></td>
                        </tr>
                        <tr>
                            <td align="right"><?php print $pgv_lang['password']; ?></td>
                            <td><input type="password" name="pass1"></td>
                        </tr>
                        <tr>
                            <td align="right"><?php print $pgv_lang['confirm']; ?></td>
                            <td><input type="password" name="pass2"></td>
                        </tr>
                        <tr>
                            <td align="right"><?php print $pgv_lang['emailadress']; ?></td>
                            <td><input type="text" name="emailadress" size="45"></td>
                        </tr>
                    </table>
...
if ('update' == $action) {
    ...
    if (0 == preg_match("'://'", $NEW_SERVER_URL)) {
    ...
    if ('index' == $_POST['NEW_PGV_DATABASE']) {
        $_POST['NEW_DBTYPE'] = '';
    }
...
?>
    ...
    <form method="post" name="configform" action="editconfig.php">
        ...
        if (!check_db()) {
            ...
            if ((true === $CONFIGURED) && ('db' == $PGV_DATABASE)) {
        ...
        <table class="facts_table">
            <tr>
                ...
                <td class="facts_value"><select name="NEW_PGV_DATABASE" tabindex="<?php $i++;
                    print $i ?>" onfocus="getHelp('PGV_DATABASE_help');" onchange="show_mysql(this, 'mysql-options');">
                        <option value="index" <?php if ('index' == $PGV_DATABASE) {
                        print 'selected="selected"';
                    } ?>><?php print $pgv_lang['index']; ?></option>
                        <option value="db" <?php if ('db' == $PGV_DATABASE) {
                        print 'selected="selected"';
                    } ?>><?php print $pgv_lang['db']; ?></option>
                    </select>
                </td>
            </tr>
        </table>
        <div id="mysql-options" style="display: <?php if ('db' == $PGV_DATABASE) {
                        print 'block';
                    } else {
                        print 'none';
                    } ?>;">
            <table class="facts_table">
                <tr>
                    ...
                    <td class="facts_value"><select name="NEW_DBTYPE" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('DBTYPE_help');">
                            <!--<option value="dbase" <?php if ('dbase' == $DBTYPE) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['dbase']; ?></option>-->
                            <option value="fbsql" <?php if ('fbsql' == $DBTYPE) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['fbsql']; ?></option>
                            <option value="ibase" <?php if ('ibase' == $DBTYPE) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['ibase']; ?></option>
                            <option value="ifx" <?php if ('ifx' == $DBTYPE) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['ifx']; ?></option>
                            <option value="msql" <?php if ('msql' == $DBTYPE) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['msql']; ?></option>
                            <option value="mssql" <?php if ('mssql' == $DBTYPE) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['mssql']; ?></option>
                            <option value="mysql" <?php if ('mysql' == $DBTYPE) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['mysql']; ?></option>
                            <option value="mysqli" <?php if ('mysqli' == $DBTYPE) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['mysqli']; ?></option>
                            <option value="oci8" <?php if ('oci8' == $DBTYPE) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['oci8']; ?></option>
                            <option value="pgsql" <?php if ('pgsql' == $DBTYPE) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['pgsql']; ?></option>
                            <option value="sqlite" <?php if ('sqlite' == $DBTYPE) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['sqlite']; ?></option>
                            <!--<option value="sybase" <?php if ('sybase' == $DBTYPE) {
                            print 'selected="selected"';
                        } ?>><?php print $pgv_lang['sybase']; ?></option>-->
                        </select>
                    </td>
                </tr>
                <tr>
                    <td class="facts_label"><?php print $pgv_lang['DBHOST']; ?> <a href="#" onclick="return helpPopup('DBHOST_help');"><b>?</b></a></td>
                    <td class="facts_value"><input type="text" name="NEW_DBHOST" value="<?php print XOOPS_DB_HOST ?>" size="40" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('DBHOST_help');"></td>
                </tr>
                <tr>
                    <td class="facts_label"><?php print $pgv_lang['DBUSER']; ?> <a href="#" onclick="return helpPopup('DBUSER_help');"><b>?</b></a></td>
                    <td class="facts_value"><input type="text" name="NEW_DBUSER" value="<?php print XOOPS_DB_USER ?>" size="40" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('DBUSER_help');"></td>
                </tr>
                <tr>
                    <td class="facts_label"><?php print $pgv_lang['DBPASS']; ?> <a href="#" onclick="return helpPopup('DBPASS_help');"><b>?</b></a></td>
                    <td class="facts_value"><input type="password" name="NEW_DBPASS" value="<?php print XOOPS_DB_PASS ?>" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('DBPASS_help');"></td>
                </tr>
                <tr>
                    <td class="facts_label"><?php print $pgv_lang['DBNAME']; ?> <a href="#" onclick="return helpPopup('DBNAME_help');"><b>?</b></a></td>
                    <td class="facts_value"><input type="text" name="NEW_DBNAME" value="<?php print XOOPS_DB_NAME ?>" size="40" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('DBNAME_help');"></td>
                </tr>
                <tr>
                    <td class="facts_label"><?php print $pgv_lang['TBLPREFIX']; ?> <a href="#" onclick="return helpPopup('TBLPREFIX_help');"><b>?</b></a></td>
                    <td class="facts_value"><input type="text" name="NEW_TBLPREFIX" value="<?php print XOOPS_DB_PREFIX . '_pgv_' ?>" size="40" tabindex="<?php $i++;
                        print $i ?>" onfocus="getHelp('TBLPREFIX_help');"></td>
                </tr>
            </table>
        </div>
        <table class="facts_table">
            <tr>
                ...
                <td class="facts_value"><select name="NEW_ALLOW_CHANGE_GEDCOM" tabindex="<?php $i++;
                    print $i ?>" onfocus="getHelp('ALLOW_CHANGE_GEDCOM_help');">
                        <option value="yes" <?php if ($ALLOW_CHANGE_GEDCOM) {
                        print 'selected="selected"';
                    } ?>><?php print $pgv_lang['yes']; ?></option>
                        <option value="no" <?php if (!$ALLOW_CHANGE_GEDCOM) {
                        print 'selected="selected"';
            ...
            <tr>
                ...
                <td class="facts_value"><input type="text" size="50" name="NEW_INDEX_DIRECTORY" value="<?php print $INDEX_DIRECTORY ?>" dir="ltr" tabindex="<?php $i++;
                    print $i ?>" onfocus="getHelp('INDEX_DIRECTORY_help');"></td>
            </tr>
            <tr>
                ...
                <td class="facts_value"><input size="50" type="text" id="NEW_AUTHENTICATION_MODULE" name="NEW_AUTHENTICATION_MODULE" value="<?php print $AUTHENTICATION_MODULE ?>" dir="ltr" tabindex="<?php $i++;
                    print $i ?>" onfocus="getHelp('AUTHENTICATION_MODULE_help');"></td>
            </tr>
            <tr>
                ...
                <td class="facts_value"><select name="NEW_PGV_STORE_MESSAGES" tabindex="<?php $i++;
                    print $i ?>" onfocus="getHelp('PGV_STORE_MESSAGES_help');">
                        <option value="yes" <?php if ($PGV_STORE_MESSAGES) {
                        print 'selected="selected"';
                    } ?>><?php print $pgv_lang['yes']; ?></option>
                        <option value="no" <?php if (!$PGV_STORE_MESSAGES) {
                        print 'selected="selected"';
                    } ?>><?php print $pgv_lang['no']; ?></option>
                    </select>
                </td>
            ...
            <tr>
                ...
                <td class="facts_value"><select name="NEW_USE_REGISTRATION_MODULE" tabindex="<?php $i++;
                    print $i ?>" onfocus="getHelp('USE_REGISTRATION_MODULE_help');">
                        <option value="yes" <?php if ($USE_REGISTRATION_MODULE) {
                        print 'selected="selected"';
                    } ?>><?php print $pgv_lang['yes']; ?></option>
                        <option value="no" <?php if (!$USE_REGISTRATION_MODULE) {
                        print 'selected="selected"';
                    } ?>><?php print $pgv_lang['no']; ?></option>
                    </select>
                </td>
            ...
            <tr>
                ...
                <td class="facts_value"><select name="NEW_REQUIRE_ADMIN_AUTH_REGISTRATION" tabindex="<?php $i++;
                    print $i ?>" onfocus="getHelp('REQUIRE_ADMIN_AUTH_REGISTRATION_help');">
                        <option value="yes" <?php if ($REQUIRE_ADMIN_AUTH_REGISTRATION) {
                        print 'selected="selected"';
                    } ?>><?php print $pgv_lang['yes']; ?></option>
                        <option value="no" <?php if (!$REQUIRE_ADMIN_AUTH_REGISTRATION) {
                        print 'selected="selected"';
                    } ?>><?php print $pgv_lang['no']; ?></option>
                    </select>
                </td>
            ...
            <tr>
                ...
                <td class="facts_value"><select name="NEW_PGV_SIMPLE_MAIL" tabindex="<?php $i++;
                    print $i ?>" onfocus="getHelp('PGV_SIMPLE_MAIL_help');">
                        <option value="yes" <?php if ($PGV_SIMPLE_MAIL) {
                        print 'selected="selected"';
                    } ?>><?php print $pgv_lang['yes']; ?></option>
                        <option value="no" <?php if (!$PGV_SIMPLE_MAIL) {
                        print 'selected="selected"';
                    } ?>><?php print $pgv_lang['no']; ?></option>
                    </select>
                </td>
            ...
            <tr>
                ...
                <td class="facts_value"><select name="NEW_ALLOW_USER_THEMES" tabindex="<?php $i++;
                    print $i ?>" onfocus="getHelp('ALLOW_USER_THEMES_help');">
                        <option value="yes" <?php if ($ALLOW_USER_THEMES) {
                        print 'selected="selected"';
                    } ?>><?php print $pgv_lang['yes']; ?></option>
                        <option value="no" <?php if (!$ALLOW_USER_THEMES) {
                        print 'selected="selected"';
                    } ?>><?php print $pgv_lang['no']; ?></option>
                    </select>
                </td>
            ...
            <tr>
                ...
                <td class="facts_value"><select name="NEW_ALLOW_REMEMBER_ME" tabindex="<?php $i++;
                    print $i ?>" onfocus="getHelp('ALLOW_REMEMBER_ME_help');">
                        <option value="yes" <?php if ($ALLOW_REMEMBER_ME) {
                        print 'selected="selected"';
                    } ?>><?php print $pgv_lang['yes']; ?></option>
                        <option value="no" <?php if (!$ALLOW_REMEMBER_ME) {
                        print 'selected="selected"';
                    } ?>><?php print $pgv_lang['no']; ?></option>
                    </select>
                </td>
            ...
            <tr>
                ...
                <td class="facts_value"><select name="NEW_LOGFILE_CREATE" tabindex="<?php $i++;
                    print $i ?>" onfocus="getHelp('LOGFILE_CREATE_help');">
                        <option value="none" <?php if ('none' == $LOGFILE_CREATE) {
                        print 'selected="selected"';
                    } ?>><?php print $pgv_lang['no_logs']; ?></option>
                        <option value="daily" <?php if ('daily' == $LOGFILE_CREATE) {
                        print 'selected="selected"';
                    } ?>><?php print $pgv_lang['daily']; ?></option>
                        <option value="weekly" <?php if ('weekly' == $LOGFILE_CREATE) {
                        print 'selected="selected"';
                    } ?>><?php print $pgv_lang['weekly']; ?></option>
                        <option value="monthly" <?php if ('monthly' == $LOGFILE_CREATE) {
                        print 'selected="selected"';
                    } ?>><?php print $pgv_lang['monthly']; ?></option>
                        <option value="yearly" <?php if ('yearly' == $LOGFILE_CREATE) {
                        print 'selected="selected"';
            ...
            <tr>
                ...
                <td class="facts_value"><input type="text" name="NEW_SERVER_URL" value="<?php print $SERVER_URL ?>" dir="ltr" tabindex="<?php $i++;
                    print $i ?>" onfocus="getHelp('SERVER_URL_help');" size="100">
                    <br><?php
            ...
            <tr>
                ...
                <td class="facts_value"><input type="text" name="NEW_LOGIN_URL" value="<?php print $LOGIN_URL ?>" dir="ltr" tabindex="<?php $i++;
                    print $i ?>" onfocus="getHelp('LOGIN_URL_help');" size="100">
                </td>
            </tr>
            <tr>
                ...
                <td class="facts_value"><input type="text" size="50" name="NEW_PGV_SESSION_SAVE_PATH" value="<?php print $PGV_SESSION_SAVE_PATH ?>" tabindex="<?php $i++;
                    print $i ?>" onfocus="getHelp('PGV_SESSION_SAVE_PATH_help');"></td>
            </tr>
            <tr>
                <td class="facts_label"><?php print $pgv_lang['PGV_SESSION_TIME']; ?> <a href="#" onclick="return helpPopup('PGV_SESSION_TIME_help');"><b>?</b></a></td>
                <td class="facts_value"><input type="text" name="NEW_PGV_SESSION_TIME" value="<?php print $PGV_SESSION_TIME ?>" tabindex="<?php $i++;
                    print $i ?>" onfocus="getHelp('PGV_SESSION_TIME_help');"></td>
            </tr>
            <tr>
                <td class="facts_label"><?php print $pgv_lang['PGV_MEMORY_LIMIT']; ?> <a href="#" onclick="return helpPopup('PGV_MEMORY_LIMIT_help');"><b>?</b></a></td>
                <td class="facts_value"><input type="text" name="NEW_PGV_MEMORY_LIMIT" value="<?php print $PGV_MEMORY_LIMIT ?>" tabindex="<?php $i++;
                    print $i ?>" onfocus="getHelp('PGV_MEMORY_LIMIT_help');"></td>
            </tr>
        </table>
        <br>
