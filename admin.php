...
if (count($pgv_changes) > 0) {
    $d_pgv_changes = "<a href=\"#\" onclick=\"window.open('edit_changes.php','','width=600,height=600,resizable=1,scrollbars=1'); return false;\">" . $pgv_lang['accept_changes'] . "</a>\n";
}
...
$d_img_module_str = '&nbsp;';
if (file_exists($PGV_BASE_DIRECTORY . 'img_editconfig.php')) {
...
<div class="center"><!--center-->
    <table class="facts_table, <?php print $TEXT_DIRECTION ?>">
        ...
        <tr>
            ...
            <td class="facts_value"><?php if ('' != $d_pgv_changes) {
                    print $d_pgv_changes;
                } else {
                    print '&nbsp;';
                } ?></td>
        ...
        <?php if ($MULTI_MEDIA_DB && userIsAdmin(getUserName())) { ?>
            <tr>
            <td class="facts_value"><a href=addmedia.php?ged=<?php print $GEDCOM; ?>><?php print_text('add_media_records'); ?></a></td>
